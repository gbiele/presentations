...
## Document analysis pipeline in R Markdown {background-image="pngs/Science.png" background-size="65%" background-opacity="0.25" background-position="right"}
...
- R Markdown-based package to write APA-6 compliant papers
